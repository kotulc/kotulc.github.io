...
I have found Jupyter Notebooks to be a great tool for learning new libraries and experimentation. Below are a few of my notebooks that include code for plotly, pandas and scikit. I have included links to the static HTLM pages along with the interactive version of the notebooks using the Jupyter nbviewer.
